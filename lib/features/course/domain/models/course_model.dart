...
class Course {
  ...
  factory Course.fromJson(Map<String, dynamic> json) => Course(
        ...
        studentsEnrollments: json["studentsEnrollments"] == null
            ? []
            : List<StudentsEnrollment>.from(json["studentsEnrollments"]!
                .map((x) => StudentsEnrollment.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "studentsEnrollments": studentsEnrollments == null
            ? []
            : List<dynamic>.from(studentsEnrollments!.map((x) => x.toJson())),
...
class StudentsEnrollment {
  ...
  factory StudentsEnrollment.fromJson(Map<String, dynamic> json) =>
      StudentsEnrollment(
        id: json["id"],
